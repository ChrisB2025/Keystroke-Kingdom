"""
Django settings for Keystroke Kingdom project.
"""
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'dev-secret-key-change-in-production-django-keystroke-kingdom')
...
CSRF_TRUSTED_ORIGINS = [
    'https://*.railway.app',
    'https://*.mmtaction.uk',  # Custom domain
]
